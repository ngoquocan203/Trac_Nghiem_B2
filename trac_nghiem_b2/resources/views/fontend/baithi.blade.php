...
<body>
  ...
  <script type="text/javascript">
    ...
    function CheckResult(){
      ...
      let form ='';
      var question = [];
      let cauhoiliet = questions.find(x=>x.idloaicauhoi == 12)
      ...
      form+= '<form style=" border: 2px solid red;width:450px;">';
        ...
        form+= '<h2 style="color:red">Kết quả thi</h2>';
        ...
        form+= '<div class="mb-3"><label for="disabledTextInput" class="form-label"><h5>Điểm của bạn là :<span style="color:red;font-weight:bold">'+diem+'</span></h5></label></div>';
        ...
        form+= '</fieldset>';
        form+='<label style="margin:20px 20px 20px 120px;"><a href="{{url('thithu')}}"><button type="button" name="button" class="btn btn-success" style="width: 200px;">Thi lại</button></a></label> &nbsp;';
      form+= '</form> ';
      ...
      $.ajax({
        ...
        success:function(data)
        {
          ...
          $.each(questions,function(k,v){
            //console.log(k,v);
            d+= '<div id="luachon">'
              d+= ' <div class="radio col-md-12" style="font-size: 20px;padding-bottom:20px;" id="check'+v['id']+'">';
